...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `demodb`.`credit card_BEFORE_INSERT` BEFORE INSERT ON `credit card` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `demodb`.`credit card_BEFORE_UPDATE` BEFORE UPDATE ON `credit card` FOR EACH ROW
BEGIN
DECLARE CC_type,baddata INT;  
    SET baddata = 0;  
    IF NEW.CC_type not in ('VISA','MSTC') THEN  
...
-- Dump completed on 2020-11-07  2:14:53
